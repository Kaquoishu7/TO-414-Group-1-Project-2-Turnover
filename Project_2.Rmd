...
### KNN Model 
For the KNN model, we used cross-validation with the train() function. Overall, the KNN model has an accuracy of 96% and a Kappa of 46.97%. The model is skewed toward false negatives. 
