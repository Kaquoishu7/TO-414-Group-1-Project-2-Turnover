...
str(turnoverUS)
cor(turnoverUS$distance, turnoverUS$turnover)
cor(turnoverUS$training_score, turnoverUS$turnover)
cor(turnoverUS$logical_score, turnoverUS$turnover)
cor(turnoverUS$avg_literacy, turnoverUS$turnover)
cor(turnoverUS$location_age, turnoverUS$turnover)
cor(turnoverUS$similar_language, turnoverUS$turnover)
cor(turnoverUS$time, turnoverUS$turnover)
...
dt_model <- C5.0(as.factor(turnover) ~ ., data = turnoverUS)
