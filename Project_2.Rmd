...
turnover_stack_dt <- C5.0(as.factor(testRegLabels1) ~ ., data = turnover_stack_train, costs = error_cast)
```
```{r}
...
confusionMatrix(as.factor(turnover_stack_model), as.factor(turnover_stack_test$testRegLabels1))
```
