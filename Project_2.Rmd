...
trainNorm1KNN =turnover_norm[-testIndices1,
                          -match("y",names(turnover_norm))]
testNorm1KNN =turnover_norm[testIndices1,
                          -match("y",names(turnover_norm))]

trainRegLabels1 = turnover[-testIndices1,"y"]
testRegLabels1 = turnover[testIndices1,"y"]

trainNormLabels1 = turnover[-testIndices1,"y"]
testNormLabels1 = turnover[testIndices1, "y"]
